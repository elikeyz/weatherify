...
const Favorites = () => {
    ...
    useEffect(() => {
        Promise.all(favorites.map(city => axios.get(`http://api.weatherstack.com/current?access_key=b49788cab88c05f33ce5464abe60ff07&query=${city.location.name},${city.location.country}`)))
            .then((result) => {
